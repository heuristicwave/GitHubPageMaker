...
scope에 명시된 기능을 Resource Server로부터 제공받습니다. 해당 절차가 `Abstract Protocol Flow` 그림의 B ~ F에 해당합니다.

> 🛎 위 2가지 Flow가 OAuth 2.0의 전체 Flow는 아닙니다. Autorization Code, Refresh Token 등 **중요 개념들이 상당히 생략** 되어 있습니다.

### More Information

지금까지 생소한 정보들을 쏟아내다 보니, 독자여려분들이 굉장히 혼란스러울 것 같습니다. (처음 OAuth를 공부했던 제가 그랬습니다 😵‍💫)
