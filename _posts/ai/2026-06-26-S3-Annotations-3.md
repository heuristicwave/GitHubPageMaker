...
```text
원본 로그 + 운영 맥락:       100,084 tokens
Annotation Context Layer:      75,090 tokens
감소율:                        약 25.0%
Accuracy:                      5/5 -> 5/5
```
...
```text
Nova 2 Lite + 원본 로그 + 운영 맥락:                 223,466 tokens
Nova 2 Lite + Annotation Context Layer:    58,059 tokens
```
