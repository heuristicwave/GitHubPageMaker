...
![OKF on S3 annotations](/assets/built/images/post/ai/s3-annotations/architecture.svg)
...
![OKF Context Inspector search result](/assets/built/images/post/ai/s3-annotations/okf-context-inspector-search.png)
...
![OKF Context Inspector annotation payload and link graph](/assets/built/images/post/ai/s3-annotations/okf-context-inspector-payload-graph.png)
