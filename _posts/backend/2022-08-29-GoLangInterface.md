...
**인터페이스 변수 a를 ConcreteType으로 변환하는 예시**
...
<details><summary markdown="span">👀 구체화된 다른 타입으로 변환하는 예시</summary>
...
예를 들어 방금 예시에서 아래와 같이 **Student 구조체**가 **String() 메서드**를 포함하지 않는다면, **컴파일 타임** 에러가 발생합니다. 
